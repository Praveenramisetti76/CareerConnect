...
const Navbar = () => {
  ...
  const shouldShowNavbar = () => {
    ...
    // Show navbar on auth pages and public pages
  ...
  const getNavigationItems = () => {
    ...
    // Show public navigation for auth pages and public pages
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center">
              ...
              (!user &&
                ...
                // Show login/signup buttons on auth pages and public pages when not logged in
