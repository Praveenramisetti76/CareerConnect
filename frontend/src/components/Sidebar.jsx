    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 256 256"
        >
          <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24ZM87.51,196.29A8,8,0,1,1,72.49,183.71a80.05,80.05,0,0,1,0-111.42,8,8,0,1,1,15,5.58,64,64,0,0,0,0,100.26A8,8,0,0,1,87.51,196.29ZM128,192a8,8,0,0,1-8-8V72a8,8,0,0,1,16,0V184A8,8,0,0,1,128,192Zm55.51,4.29a8,8,0,0,1-15-5.58,64,64,0,0,0,0-100.26,8,8,0,1,1,15-5.58,80.05,80.05,0,0,1,0,111.42Z" />
        </svg>
      ),
    },
    {
